...
CREATE TYPE IF NOT EXISTS public.app_role AS ENUM ('farmer', 'merchant', 'expert', 'admin');
...
CREATE TYPE IF NOT EXISTS public.notification_type AS ENUM ('info', 'warning', 'error', 'success', 'reminder');
