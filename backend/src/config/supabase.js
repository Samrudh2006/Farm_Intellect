...
const supabaseServiceRoleKey = getScopedEnv('SUPABASE_SERVICE_ROLE_KEY') || process.env.SUPABASE_SERVICE_ROLE_KEY;
...
export const hasSupabaseServiceConfig = Boolean(supabaseUrl && supabaseServiceRoleKey);

export const supabaseAdminClient = hasSupabaseServiceConfig
